...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__todoItem_js__ = __webpack_require__(4);
/*
...
class TodoList {
	...
	onAddTodo(event) {
		...
		if (value) {
			item = new __WEBPACK_IMPORTED_MODULE_0__todoItem_js__["a" /* TodoItem */](value, false, this.options.item, this.list);
			this.add(item);
...
let desk = new __WEBPACK_IMPORTED_MODULE_1__todoListBuilder_js__["a" /* TodoBuilder */](boardElement, {
    boardClasses: 'row-24',
